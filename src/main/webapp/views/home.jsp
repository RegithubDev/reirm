  ...
  <div class="col-12 mb-4">
    ...
    <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" id="swiper-multiple-slides">
      <div class="swiper-wrapper" id="swiper-wrapper-32b8f58f7210e384e" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
        <div class="swiper-slide swiper-slide-active" style="background-image: url(&quot;<%=request.getContextPath() %>/resources/images/logo/protect-main.png&quot;); width: 444px; margin-right: 30px;" role="group" aria-label="1 / 5">Slide 1</div>
        <div class="swiper-slide swiper-slide-next" style="background-image: url(&quot;<%=request.getContextPath() %>/resources/images/logo/protect-main.png&quot;); width: 444px; margin-right: 30px;" role="group" aria-label="2 / 5">Slide 2</div>
        <div class="swiper-slide" style="background-image: url(&quot;<%=request.getContextPath() %>/resources/images/logo/protect-main.png&quot;); width: 444px; margin-right: 30px;" role="group" aria-label="3 / 5">Slide 3</div>
        <div class="swiper-slide" style="background-image: url(&quot;<%=request.getContextPath() %>/resources/images/logo/protect-main.png&quot;); width: 444px; margin-right: 30px;" role="group" aria-label="4 / 5">Slide 4</div>
        <div class="swiper-slide" style="background-image: url(&quot;<%=request.getContextPath() %>/resources/images/logo/protect-main.png&quot;); width: 444px; margin-right: 30px;" role="group" aria-label="5 / 5">Slide 5</div>
      </div>
